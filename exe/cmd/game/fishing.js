module.exports = {
  exe: async function(message, prefix, command, args, lang){
    ...
    const invite = await client.discordTogether.createTogetherCode(channel.id, 'fishing');
  ...
  config: { name: "fishing", aliases: ["fsh"], category: "game", system: { perms: ["SEND_MESSAGES", "EMBED_LINKS"], delInvoke: false, inProgress: false, staffCommand: false, devCommand: false } },
  path: null
}